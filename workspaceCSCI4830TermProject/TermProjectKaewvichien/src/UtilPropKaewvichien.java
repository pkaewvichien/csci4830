...
public class UtilPropKaewvichien {
   static final boolean _W = System.getProperty("os.name").toLowerCase().contains("windows");
   static String _PROP_FILENAME_WIN_LOCAL = "C:\\Users\\phoom\\workspace4830\\TermProjectKaewvichien\\TermProjectKaewvichien\\WebContent\\config.properties";
